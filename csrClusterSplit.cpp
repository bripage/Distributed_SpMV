...
void csrClusterSplit(char *filename, std::vector<int>& origin_row, std::vector<int>& origin_col,
    ...
    MMCOO_to_CSR(filename, origin_row, origin_col, origin_data, rowCount, colCount, nonZeros);
