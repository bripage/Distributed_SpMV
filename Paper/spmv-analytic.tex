\section{An Analytic Model}\label{sec:spmv-analytic}
...
\begin{figure}\begin{centering}
\includegraphics[scale=1]{../figures/spmv-flop-per-byte-vs-P.eps}
...
\begin{figure}\begin{centering}
\includegraphics[scale=1]{../figures/spmv-partial-speedup.eps}
